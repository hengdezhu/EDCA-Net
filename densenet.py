...
from typing import Any, Callable, cast, Dict, List, Mapping, Optional, TypeVar, Tuple, Type
...
class _DenseLayer(nn.Module):
    def __init__(
        ...
        self.eca = eca_layer(growth_rate)
    ...
    def forward(self, input: Tensor) -> Tensor:  # noqa: F811
        ...
        # comment this line if want to remove attention from densenet
...
def dcanet121(*, weights: Optional[DenseNet121_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet:
